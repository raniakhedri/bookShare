                ...
                <div class="p-8">
                    <form action="{{ route('groups.events.store', $group) }}" method="POST" id="eventForm" class="space-y-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="resources" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center">
                                        <svg class="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                                        </svg>
                                        Ressources fournies
                                    </label>
                                    <textarea class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent dark:bg-gray-700 dark:text-white placeholder-gray-400 resize-none transition-all duration-200 @error('resources') border-red-500 @enderror" 
                                              id="resources" 
                                              name="resources" 
                                              rows="4" 
                                              placeholder="Exemple:&#10;Livres de référence&#10;Support de présentation&#10;Rafraîchissements">{{ old('resources') }}</textarea>
                                    @error('resources')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                        Une ressource par ligne. Que fournirez-vous aux participants ?
                                    </p>
                                </div>
