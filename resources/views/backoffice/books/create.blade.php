        ...
        <div class="col-lg-8">
            <div class="card shadow-lg border-0 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-400 text-white">
                <div class="card-header bg-transparent text-center py-4 rounded-top border-0">
                    <h3 class="mb-0 font-weight-bold text-white drop-shadow-lg">Add a Book</h3>
                </div>
                <div class="card-body bg-white/80 rounded-bottom">
                    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="row g-4">
                        @csrf
                        <div class="col-md-6">
                            <label for="title" class="form-label text-indigo-700">Title</label>
                            <input type="text" class="form-control rounded-pill shadow-sm border-indigo-200 focus:border-pink-400" id="title" name="title" required>
                        </div>
                        <div class="col-md-6">
                            <label for="author" class="form-label text-pink-700">Author</label>
                            <input type="text" class="form-control rounded-pill shadow-sm border-pink-200 focus:border-indigo-400" id="author" name="author" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control rounded-pill shadow-sm border-indigo-200 focus:border-pink-400" id="publication_year" name="publication_year">
                        </div>
                        <div class="col-md-6">
