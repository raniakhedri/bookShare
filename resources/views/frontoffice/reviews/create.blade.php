    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center space-x-4 mb-8">
            ...
            <div>
                ...
                <h2 class="text-xl text-gray-700 font-medium">{{ $book->title }}</h2>
    ...
    @endif
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        @endfor
                        <span id="overall_rating_text" class="ml-3 text-gray-600 font-medium">Click to rate</span>
                    </div>
                ...
                <!-- Content Warnings -->
                <div class="mb-6" id="contentWarningsDiv" style="display: none;">
