                        ...
                        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm px-6 py-4 border-b border-blue-200 dark:border-blue-700">
                            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900 dark:text-black">PDF Preview</h3>
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ asset('storage/' . $book->file) }}" 
                                       download 
                                       class="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-black rounded-lg font-medium hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 flex items-center gap-2 shadow hover:shadow-lg">
                        ...
                        <div>
                            ...
                            <div class="bg-white p-4 rounded-lg border">
                                <div class="flex items-center mb-2">
                                    ...
                                    @endfor
                                    <span class="ml-2 text-sm text-gray-600">by {{ $topReview->user->name }}</span>
                                </div>
