            ...
            @if($books->count() > 0)
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    @foreach($books as $book)
                        <div
                            class="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 overflow-hidden">
                            <!-- Book Image -->
                            <div class="relative overflow-hidden h-64">
                                ...
                                @else
                                    <div
                                        ...
                                        <div class="text-center">
                                            <svg class="w-16 h-16 text-blue-400 mx-auto mb-2" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <!-- Hover Effect Overlay for Image Only -->
                                <div
                                ...
                                <div class="absolute bottom-4 left-4 z-10">
                                    @if(isset($book->price) && $book->price > 0)
                                        <span
                                            class="px-3 py-1 text-sm font-bold text-white bg-gradient-to-r from-purple-600 to-pink-600 rounded-full shadow-lg">
                                            ${{ number_format($book->price, 2) }}
                                        </span>
                                    @else
                                        <span
                                            class="px-3 py-1 text-sm font-bold text-white bg-gradient-to-r from-green-500 to-emerald-500 rounded-full shadow-lg">
                                            FREE
                                        </span>
                                    @endif
                                </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-700">{{ $book->owner->name ?? 'Unknown Owner' }}
                                            </p>
                                ...
                                <div class="flex space-x-2 relative z-10">
                                    ...
                                    @auth
                                        ...
                                        @else
                                            <button
                                                class="flex-1 bg-gradient-to-r from-gray-400 to-gray-500 text-white py-2 px-4 rounded-xl font-semibold text-sm cursor-not-allowed">
                                                Your Book
                                            </button>
                                        @endif
                                    @else
